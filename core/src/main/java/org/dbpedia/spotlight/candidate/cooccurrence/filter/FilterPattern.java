...
/**
 * A filter for basic, recurring patterns related to dates, times, etc.
 *
...
public class FilterPattern extends Filter {
	...
	protected String BLACKLIST_PATTERN = "(Monday|Tuesday|Wednesday|Thursday|Friday|Saturday|Sunday|" +
