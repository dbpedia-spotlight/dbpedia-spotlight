...
import org.dbpedia.spotlight.model.RequiresAnalyzedText;
import org.dbpedia.spotlight.model.SurfaceFormOccurrence;
import org.dbpedia.spotlight.model.TaggedText;
import org.dbpedia.spotlight.spot.SpotSelector;
import org.dbpedia.spotlight.spot.selectors.cooccurrence.ClassifierFactory;
import org.dbpedia.spotlight.spot.selectors.cooccurrence.classification.SpotClass;
import org.dbpedia.spotlight.spot.selectors.cooccurrence.classification.SpotClassification;
import org.dbpedia.spotlight.spot.selectors.cooccurrence.classification.SpotClassifier;
 ...
 */
public class CoOccurrenceBasedSelector implements SpotSelector, RequiresAnalyzedText {
	 ...
	 *
	 * @see org.dbpedia.spotlight.spot.selectors.cooccurrence.features.data.OccurrenceDataProvider
	 * @see ClassifierFactory
	 *
     * @throws InitializationException Either the OccurrenceDataProvider or the ClassifierFactory
	 * 			could not be initialized.
	 */
	public CoOccurrenceBasedSelector(String databaseDriver, String databaseConnector, String databaseUser, String databasePassword, InputStream classifierUnigram, InputStream classifierNgram, String datasource) throws InitializationException {
		
		LOG.info("Initializing spot occurrence data provider.");
		OccurrenceDataProviderSQL.initialize(databaseDriver, databaseConnector, databaseUser, databasePassword);
		LOG.info("Done.");

		LOG.info("Initializing spot candidate classifiers.");
		new ClassifierFactory(classifierUnigram,
				classifierNgram,
				datasource,
