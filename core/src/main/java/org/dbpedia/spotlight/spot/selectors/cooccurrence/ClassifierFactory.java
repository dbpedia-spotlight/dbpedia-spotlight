...
public class ClassifierFactory {
	 ...
	 * to select the proper {@link org.dbpedia.spotlight.spot.selectors.cooccurrence.weka.InstanceBuilder}.
	 * @param dataProvider occurrence data provider used in the InstanceBuilder.
	 * @throws InitializationException Error during 
	 */
	public ClassifierFactory(InputStream unigramModelFile, InputStream ngramModelFile,
