package org.dbpedia.spotlight.spot.selectors.cooccurrence.classification;
...
public class SpotClassifier {
	...
	protected InputStream modelFile;
	 ...
	 */
	public SpotClassifier(InputStream modelFile, OccurrenceDataProvider dataProvider, InstanceBuilder instanceBuilder)
