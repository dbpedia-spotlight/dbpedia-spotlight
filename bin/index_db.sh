...
#Download:
cd $1/processed/
curl http://downloads.dbpedia.org/current/$2/redirects_$2.nt.bz2 | gzcat > redirects.nt
curl http://downloads.dbpedia.org/current/$2/disambiguations_$2.nt.bz2 | gzcat > disambiguations.nt
...
mvn clean install; mvn -pl index package exec:java -Dexec.mainClass=org.dbpedia.spotlight.db.CreateSpotlightModel -Dexec.args="$1/processed/ $5 $1/opennlp $3 $4";
