...
public class Annotate {
    ...
    public Response postHTML(
      ...
      @DefaultValue(SpotlightConfiguration.DEFAULT_COREFERENCE_RESOLUTION) @FormParam("coreferenceResolution") boolean coreferenceResolution
        ...
        return getHTML(text,confidence,support,dbpediaTypes,sparqlQuery,policy,coreferenceResolution);
    }
    ...
    public Response postRDFa(
      ...
      @DefaultValue(SpotlightConfiguration.DEFAULT_COREFERENCE_RESOLUTION) @FormParam("coreferenceResolution") boolean coreferenceResolution
        ...
        return getRDFa(text,confidence,support,dbpediaTypes,sparqlQuery,policy,coreferenceResolution);
    }
    ...
    public Response postXML(
      ...
      @DefaultValue(SpotlightConfiguration.DEFAULT_COREFERENCE_RESOLUTION) @FormParam("coreferenceResolution") boolean coreferenceResolution
        ...
        return getXML(text,confidence,support,dbpediaTypes,sparqlQuery,policy,coreferenceResolution);
    }
    ...
    public Response postJSON(
      ...
      @DefaultValue(SpotlightConfiguration.DEFAULT_COREFERENCE_RESOLUTION) @FormParam("coreferenceResolution") boolean coreferenceResolution
        ...
        return getJSON(text,confidence,support,dbpediaTypes,sparqlQuery,policy,coreferenceResolution);
      }
